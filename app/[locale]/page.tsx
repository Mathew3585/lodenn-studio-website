...
export default function Home() {
  ...
  // Hooks pour animations CSS mobile
  const heroAnim = useMobileAnimations();
  const aetherisAnim = useMobileAnimations();
    ...
    <div className="relative bg-black">
      ...
      <section className="relative h-screen overflow-hidden">
        ...
        <div ref={heroAnim.ref} className="relative z-10 h-full flex flex-col items-center justify-center px-6 sm:px-4">
          ...
          {isMobile ? (
            <h1 className={`text-5xl sm:text-7xl lg:text-8xl font-bold mb-6 text-center mobile-animate-init ${heroAnim.isVisible ? 'animate-mobile-fade-in-up animate-delay-100' : ''}`}>
          ...
          {isMobile ? (
            <p className={`text-xl sm:text-3xl lg:text-4xl mb-3 text-center text-white max-w-3xl font-light drop-shadow-lg mx-auto mobile-animate-init ${heroAnim.isVisible ? 'animate-mobile-fade-in-up animate-delay-200' : ''}`}>
              {t('hero.subtitle')}
            </p>
          ) : (
            <motion.p
          ...
          {isMobile ? (
            <p className={`text-base sm:text-xl mb-8 sm:mb-12 text-center text-gray-200 max-w-2xl drop-shadow-md mx-auto mobile-animate-init ${heroAnim.isVisible ? 'animate-mobile-fade-in-up animate-delay-300' : ''}`}>
              {t('hero.description')}
            </p>
          ) : (
            <motion.p
          ...
          {isMobile ? (
            <div className={`flex flex-col sm:flex-row gap-6 mb-16 items-center mobile-animate-init ${heroAnim.isVisible ? 'animate-mobile-scale-in animate-delay-400' : ''}`}>
        ...
        <div className="absolute bottom-8 left-0 right-0 z-10 flex justify-center">
          {isMobile ? (
            <div className="flex flex-col items-center gap-2 text-primary cursor-pointer">
              <span className="text-sm font-bold drop-shadow-lg text-center">
                {t('hero.scrollText')}
              </span>
              <svg
      ...
      <section ref={aetherisRef} className="relative min-h-screen bg-black overflow-hidden">
        ...
        <div className="relative z-10 py-16 sm:py-24 lg:py-32 px-4">
          <div ref={aetherisAnim.ref} className="max-w-7xl mx-auto">
            {/* Badge + Titre avec animations */}
            <div className="text-center mb-16">
              {isMobile ? (
                <span className={`inline-block px-6 py-3 bg-primary text-white rounded-full text-sm font-bold mb-8 shadow-2xl shadow-primary/50 mobile-animate-init ${aetherisAnim.isVisible ? 'animate-mobile-scale-in' : ''}`}>
              ...
              {isMobile ? (
                <h2 className={`text-5xl sm:text-8xl lg:text-9xl font-bold mb-6 text-white drop-shadow-2xl mobile-animate-init ${aetherisAnim.isVisible ? 'animate-mobile-fade-in-up animate-delay-100' : ''}`}>
                  Aetheris
                </h2>
              ) : (
                <motion.h2
              ...
              {isMobile ? (
                <p className={`text-xl sm:text-4xl text-primary font-light drop-shadow-lg mobile-animate-init ${aetherisAnim.isVisible ? 'animate-mobile-fade-in-up animate-delay-200' : ''}`}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
              ...
              {isMobile ? (
                <div className={`lg:col-span-2 relative h-64 sm:h-80 lg:h-[600px] rounded-2xl overflow-hidden group mobile-animate-init ${aetherisAnim.isVisible ? 'animate-mobile-fade-in-up animate-delay-300' : ''}`}>
                  <Image
              ...
              {isMobile ? (
                <div className={`relative h-56 sm:h-72 rounded-2xl overflow-hidden group mobile-animate-init ${aetherisAnim.isVisible ? 'animate-mobile-fade-in-up animate-delay-400' : ''}`}>
                  <Image
              ...
              {isMobile ? (
                <div className={`relative h-56 sm:h-72 rounded-2xl overflow-hidden group mobile-animate-init ${aetherisAnim.isVisible ? 'animate-mobile-fade-in-up animate-delay-500' : ''}`}>
                  <Image
            ...
            {/* CTA avec animation */}
            {isMobile ? (
              <div className={`text-center mobile-animate-init ${aetherisAnim.isVisible ? 'animate-mobile-scale-in animate-delay-500' : ''}`}>
                <Link
                  href="/games/aetheris"
                ...
                >
                  <span>{t('aetherisSection.discoverGame')}</span>
                  <svg
                    className="w-7 h-7"
                    fill="none"
                    stroke="currentColor"
