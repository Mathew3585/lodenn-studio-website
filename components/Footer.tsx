    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="col-span-1">
            <Link href={`/${locale}`} className="flex items-center space-x-3 mb-4">
              <Image
                ...
                className="w-10 h-10"
              />
              <span className="text-xl font-bold">Lodenn Studio</span>
            </Link>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href={`/${locale}/games/aetheris`} className="text-gray-400 hover:text-primary transition-colors">
                  {tNav('aetheris')}
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400 text-sm">
          <p>&copy; {new Date().getFullYear()} Lodenn Studio. {t('copyright')}</p>
        </div>
      </div>
    </footer>
  );
